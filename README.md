...
`.env` dosyası repoda hazır gelir. Tek komutla kurulum tamamlanır:
...
- Veritabanı ve servisleri başlatır
- Migration ve admin kullanıcısı oluşturmayı otomatik çalıştırır
- Server ve worker'ı ayağa kaldırır
